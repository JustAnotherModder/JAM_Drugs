...
function JAM_Drugs:UpdateMarkers()
    ...
    --         self:MarkerHandler(val.Pos, val.Scale)
    --     end
...
function JAM_Drugs:PurchaseDrugs(zone, amount)
    ...
    ESX.TriggerServerCallback('JAM_Drugs:PurchaseDrug', function(valid, msg, finalprice)         
        if not valid then
            TriggerEvent('esx:showNotification', "You can't " .. msg .. " that much " .. str .. ".")
        elseif valid then          
            TriggerEvent('esx:showNotification', "You purchased " .. amount .. " " .. str .. " for $" .. finalprice .. msg)
...
function JAM_Drugs:SellDrugs(zone, amount)  
    ...
    ESX.TriggerServerCallback('JAM_Drugs:SellDrug', function (valid)
        if not valid then
            ...
            TriggerEvent('esx:showNotification', "You sold " .. amount .. " " .. str .. " for $" .. (zone.Price * amount) .. " dirty money.")
