		...
		Zones = {
			CocaineLab = {
				...
				SafeRewards			= { 
					...
					Weapons = { 
					"WEAPON_COMBATMG_MK2", "WEAPON_SPECIALCARBINE_MK2", "WEAPON_ASSAULTSMG", "WEAPON_ASSAULTSHOTGUN", "WEAPON_REVOLVER", 
					"WEAPON_PUMPSHOTGUN_MK2", "WEAPON_ASSAULTRIFLE", "WEAPON_SMG_MK2", "WEAPON_REVOLVER_MK2", "WEAPON_COMBATMG", 
					},				
				},
